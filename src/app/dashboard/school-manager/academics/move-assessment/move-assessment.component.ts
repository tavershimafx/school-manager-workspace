...
@Component({
  selector: 'move-assessment',
  standalone: false,
  templateUrl: './move-assessment.component.html',
  styleUrl: './move-assessment.component.css'
})
export class MoveAssessmentModal implements OnInit {
  @Input() data?: {

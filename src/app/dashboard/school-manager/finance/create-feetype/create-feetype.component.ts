...
@Component({
  selector: 'create-feetype',
  standalone: false,
  templateUrl: './create-feetype.component.html',
  styleUrl: './create-feetype.component.css'
})
export class CreateFeeTypeModal implements OnInit {
  @Input() data?: {

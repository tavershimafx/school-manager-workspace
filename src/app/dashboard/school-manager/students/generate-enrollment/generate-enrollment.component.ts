...
@Component({
  selector: 'generate-enrollment',
  standalone: false,
  templateUrl: './generate-enrollment.component.html',
  styleUrl: './generate-enrollment.component.css'
})
export class GenerateEnrollmentModal implements OnInit {
  @Input() data?: {
